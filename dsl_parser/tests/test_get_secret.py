...
"""
    ...
    def test_validate_secrets_all_invalid(self):
        expected_message = "Required secrets don't exist in this tenant: " \
                           "target_op_secret_id, node_template_secret_id, "\
                           "ip, agent_key, user, webserver_port, " \
                           "source_op_secret_id"
