...
AGENT_LOG_DIR_KEY = 'AGENT_LOG_DIR'
AGENT_WORK_DIR_KEY = 'AGENT_WORK_DIR'
AGENT_LOG_LEVEL_KEY = 'AGENT_LOG_LEVEL'
AGENT_LOG_MAX_BYTES_KEY = 'AGENT_LOG_MAX_BYTES'
AGENT_LOG_MAX_HISTORY_KEY = 'AGENT_LOG_MAX_HISTORY'
